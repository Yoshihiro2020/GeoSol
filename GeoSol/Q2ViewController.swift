...
class Q2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        textFileName = "q2_" + String(userID!) + ".txt"
        createTextFile()
    }
    ...
    func recordData() {
        ...
        //imageをアプリ内に保存
        let fileName = "q2_" + String(userID!) + "_" + String(solution) + ".png"
    ...
    func used() {
        ...
        if(usedNum == 1) {
            clueImg.image = UIImage(named: "q2_clueB.png")
            cluePoint.image = UIImage(named: "q2_solutionB.png")
        } else if(usedNum == 2) {
            clueImg.image = UIImage(named: "q2_clueC.png")
            cluePoint.image = UIImage(named: "q2_solutionC.png")
        } else {
            endExp.isHidden = false
            clueView.isHidden = true
            doneButton.isHidden = false
    ...
    @IBAction func endQuestion(_ sender: Any) {
        let alert: UIAlertController = UIAlertController(title: "次の問題に進みますか？", message: "", preferredStyle:  UIAlertController.Style.alert)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let q2ViewController = segue.destination as! Q3ViewController
        q2ViewController.userID = userID
        q2ViewController.images = images
    }
